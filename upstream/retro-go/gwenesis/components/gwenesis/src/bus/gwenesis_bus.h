...
#if defined(RG_TARGET_HOLO_DYNMOD)
#define GWENESIS_AUDIO_OUTPUT_RATE 12000
#define AUDIO_FREQ_DIVISOR 3733
#define AUDIO_FREQ_DIVISOR_NTSC 3733
#define AUDIO_FREQ_DIVISOR_PAL 4460
#define GWENESIS_AUDIO_BUFFER_LENGTH_NTSC 240
#define GWENESIS_AUDIO_BUFFER_LENGTH_PAL 240
#else
