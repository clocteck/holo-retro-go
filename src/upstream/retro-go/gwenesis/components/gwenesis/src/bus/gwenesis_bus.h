...
/* Keep the emulation pacer and host audio drain on the same time base. */
#ifndef GWENESIS_FRAME_TARGET_FPS
...
#define GWENESIS_YM2612_SAMPLE_STEP 4
#else
#define Z80_FREQ_DIVISOR 14 // Frequency divisor to Z80 clock
#define GWENESIS_YM2612_SAMPLE_STEP 1
#endif
#define VDP_CYCLES_PER_LINE 3420 // VDP Cycles per Line
#define SCREEN_WIDTH 320

#if defined(RG_TARGET_HOLO_DYNMOD)
#define GWENESIS_AUDIO_OUTPUT_RATE 13317
#define AUDIO_FREQ_DIVISOR 4036
#define AUDIO_FREQ_DIVISOR_NTSC 4036
#define AUDIO_FREQ_DIVISOR_PAL 4036
#define GWENESIS_AUDIO_BUFFER_LENGTH_NTSC 222
#define GWENESIS_AUDIO_BUFFER_LENGTH_PAL 265
#define GWENESIS_AUDIO_BUFFER_CAPACITY (GWENESIS_AUDIO_BUFFER_LENGTH_PAL + 32)
#define GWENESIS_AUDIO_HOST_RATE_NTSC \
    (GWENESIS_AUDIO_BUFFER_LENGTH_NTSC * GWENESIS_FRAME_TARGET_FPS)
#define GWENESIS_AUDIO_HOST_RATE_PAL \
    (GWENESIS_AUDIO_BUFFER_LENGTH_PAL * GWENESIS_FRAME_TARGET_FPS)
#define GWENESIS_AUDIO_HOST_RATE GWENESIS_AUDIO_HOST_RATE_PAL
#else
#define GWENESIS_AUDIO_OUTPUT_RATE GWENESIS_AUDIO_FREQ_NTSC
#define AUDIO_FREQ_DIVISOR 1009
#define AUDIO_FREQ_DIVISOR_NTSC AUDIO_FREQ_DIVISOR
#define AUDIO_FREQ_DIVISOR_PAL AUDIO_FREQ_DIVISOR
#define GWENESIS_AUDIO_BUFFER_LENGTH_NTSC 888
#define GWENESIS_AUDIO_BUFFER_LENGTH_PAL 1056
#define GWENESIS_AUDIO_BUFFER_CAPACITY (GWENESIS_AUDIO_BUFFER_LENGTH_PAL + 8)
#endif
