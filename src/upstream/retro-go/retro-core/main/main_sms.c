...
#define SMS_SURFACE_FORMAT RG_PIXEL_PAL565_LE
#else
#define SMS_SURFACE_FORMAT RG_PIXEL_PAL565_BE
#endif
...
void sms_main(void)
{
    ...
    updates[0] = rg_surface_create(SMS_WIDTH, SMS_HEIGHT, SMS_SURFACE_FORMAT, MEM_FAST);
    updates[1] = rg_surface_create(SMS_WIDTH, SMS_HEIGHT, SMS_SURFACE_FORMAT, MEM_FAST);
