...
#define PCE_SURFACE_FORMAT RG_PIXEL_PAL565_LE
#else
#define PCE_SURFACE_FORMAT RG_PIXEL_PAL565_BE
#endif
...
void pce_main(void)
{
    ...
    updates[0] = rg_surface_create(XBUF_WIDTH, XBUF_HEIGHT, PCE_SURFACE_FORMAT, MEM_FAST);
    updates[1] = rg_surface_create(XBUF_WIDTH, XBUF_HEIGHT, PCE_SURFACE_FORMAT, MEM_FAST);
